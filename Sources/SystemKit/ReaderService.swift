...
public protocol ReaderInternalService {
    associatedtype T
...
open class Reader<T: Codable>: NSObject, ReaderInternalService {
...
extension Reader: ReaderService {
    public func lock() {
        self.locked = true
    }
