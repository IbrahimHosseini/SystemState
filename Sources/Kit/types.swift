...
extension Color: CaseIterable {
    ...
    public static var cluster: Color {
        if #available(macOS 10.14, *) {
            return Color(key: "cluster", value: "Based on cluster", additional: NSColor.controlAccentColor)
        } else {
    ...
    public static var systemAccent: Color { 
        if #available(macOS 10.14, *) {
            return Color(key: "system", value: "System accent", additional: NSColor.controlAccentColor)
        } else {
            // Fallback on earlier versions
            return Color.blue
        }
